...
orthoDiss <- function(Xr, X2 = NULL, 
  ...
  prj <- orthoProjection(Xr = Xr, Yr = Yr, X2 = X2, method = method, pcSelection = pcSelection, center = center, scaled = scaled, call. = FALSE)
  scores <- prj$scores
